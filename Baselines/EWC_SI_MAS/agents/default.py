    ...
    def learn_batch(self, train_loader, val_loader=None):
        ...
        for epoch in range(self.config['schedule'][-1]):
            ...
            if val_loader != None:
                ...
                elif all([best_val_acc > prev_acc  for prev_acc in val_accs[-self.config["e_stopping_wait"]:]]) and len(val_accs) > self.config["e_stopping_wait"] + 2:
                    print("Every Stopping")
                    break
